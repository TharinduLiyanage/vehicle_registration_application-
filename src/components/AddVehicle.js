            ...
            <div>
                ...
                <Card style={{width: '80%', marginLeft: 'auto', marginRight: 'auto'}}>
                    ...
                    <Card.Img style={{
                        ...
                        marginRight: 'auto',
                        width: '50%'
                    }} variant="top" src={car_logo}/>
                    <Card.Body>
                        <Card.Title>
                            <Alert variant="info">Register Vehicle</Alert>
                        </Card.Title>
                        <div id="form-container">
                       
                            <div id="form" style={{display: 'inline-block', position: 'relative'}} className="">
                            <input className="form-control" style={{marginBottom: '2%'}} placeholder="Owner Name"/>
                            ...
                            <input className="form-control" style={{marginBottom: '2%'}} placeholder="Owner Addres"/>
                                ...
                                <input className="form-control" style={{marginBottom: '2%'}} placeholder="Color"/>
                            </div>
